...
class KanboardFeature10Test {
    ...
    void testAddNewCategory() {
        ...
        nameField.sendKeys("New Category 2");
        driver.findElement(By.xpath("//button[text()='Save']")).click();

        // Verify the new category
        WebElement column = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath(
                        "//table[@class='table-striped']/tbody/tr[last()]/td[1]")));
        assertTrue(column.getText().contains("New Category 2"));
