...
class KanboardFeature07Test {
    ...
    void testAddColumnWithoutName() {
        ...
        // Attempt to add a new column without a name
        ...
        By title = By.xpath("//label[text()='Title']");
        ...
        driver.findElement(RelativeLocator.with(title).above(required));
