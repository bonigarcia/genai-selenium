...
class KanboardFeature13Test {
    ...
    void testCheckUserPermissions() {
        ...
        // Verify the allowed users
        By byTable = By.xpath("//table[@class='table-scrolling']/tbody/tr");
        wait.until(ExpectedConditions.visibilityOfElementLocated(byTable));
        List<WebElement> rows = driver.findElements(byTable);
        assertTrue(rows.size() == 2); // First row is the header
