...
class KanboardFeature18Test {
    ...
    void testCloseTask() {
        ...
        // Navigate to the project and task
        ...
        WebElement taskStatus = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(text(), 'closed')]")));
        assertTrue(taskStatus.isDisplayed(), "Task status should be 'Closed'");
