...
class KanboardFeature05Test {
    ...
    @Test
    void testChangeProjectDescription() {
        ...
        By description = By.xpath("//h2[text()='Description']");
        wait.until(ExpectedConditions.visibilityOfElementLocated(description));
        By required = By.xpath("//p[contains(text(), 'This is the new description')]");
        wait.until(ExpectedConditions.visibilityOfElementLocated(required));
        driver.findElement(RelativeLocator.with(description).above(required));
