...
class ExpressCartFeature12Test {
    ...
    @Test
    public void testAddDiscountCodeByAmount() {
        ...
        assertTrue(lastRowText.contains("Code:  discount000"));
