...
class ExpressCartFeature04Test {
    ...
    public void testAddDuplicateUserToSystemAndFail() {
        ...
        // Then "A user with that email address already exists" is shown in a
        // red alert at the bottom of the table
        WebElement alert = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                        "//*[contains(text(), 'A user with that email address already exists')]")));
