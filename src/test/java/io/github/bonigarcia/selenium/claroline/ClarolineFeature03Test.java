...
class ClarolineFeature03Test {
    ...
    @Test
    public void testLoginAsUser001() {
        ...
        // Then "Firstname001 Name001" is shown on the right of the screen on
        // top of the empty profile picture
        WebElement userInfo = wait
                .until(ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//div[@id='userProfileBox']")));
        assertTrue(userInfo.getText().contains("firstname001 Name001"));
