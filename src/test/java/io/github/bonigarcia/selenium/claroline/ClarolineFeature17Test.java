...
class ClarolineFeature17Test {
    ...
    public void testSearchAdmin() {
        ...
        actionSelect.selectByVisibleText("Platform administrator");
        ...
        // Then "testuser2" is shown in the "Name" column of the first row of
        // the table
        WebElement firstRowNameColumn = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                        "//table[@class='claroTable emphaseLine']/tbody/tr[1]//td[2]")));
        assertEquals("testuser3", firstRowNameColumn.getText());
