...
class MantisBTFeature07Test {
    ...
    @Test
    public void testAddExistingCategoryFailure() {
        ...
        WebElement errorMessage = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                        "//p[contains(text(),'A category with that name already exists.')]")));
        String errorMessageText = errorMessage.getText();

        // Verify the error message
        assertTrue(
                errorMessageText
                        .contains("A category with that name already exists."),
