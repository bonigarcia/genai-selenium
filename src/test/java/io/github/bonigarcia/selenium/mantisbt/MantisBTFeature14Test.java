...
class MantisBTFeature14Test {
    ...
    @Test
    public void testChangeIssueStatusToConfirmed() {
        ...
        statusSelect.selectByVisibleText("confirmed");
        ...
        assertEquals("confirmed", statusText.getText(),
