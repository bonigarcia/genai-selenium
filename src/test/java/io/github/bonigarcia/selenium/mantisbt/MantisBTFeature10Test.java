...
class MantisBTFeature10Test {
    ...
    public void testChangeIssuePriority() {
        ...
        Select prioritySelect = new Select(wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.name("priority"))));
        prioritySelect.selectByVisibleText("low");
        ...
        WebElement priorityText = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                        "//td[contains(text(),'Priority')]/following-sibling::td")));
        assertEquals("low", priorityText.getText(),
                "The expected priority is not displayed.");
