...
class MantisBTFeature18Test {
    ...
    @Test
    public void testChangeIssueSummary() {
        ...
        WebElement summaryField = wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.name("summary")));
        summaryField.clear();

        // And enters "Summary002" in the "Summary" field
        summaryField.sendKeys("Summary002");
        ...
        WebElement summaryText = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                        "//td[normalize-space(text())='Summary']/following-sibling::td")));
        assertEquals("0000001: Summary002", summaryText.getText().trim(),
