...
class MantisBTFeature12Test {
    ...
    @Test
    public void testChangeIssueStatusToAcknowledged() {
        ...
        statusSelect.selectByVisibleText("acknowledged");
        ...
        assertEquals("acknowledged", statusText.getText(),
