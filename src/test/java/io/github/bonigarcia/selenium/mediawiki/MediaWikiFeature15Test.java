...
class MediaWikiFeature15Test {
    ...
    @Test
    public void testNewlyPromotedAdminEditsProtectedPage() {
        ...
        String additionalText = " This is the additional content added by the newly promoted admin.";
