...
class MediaWikiFeature08Test {
    ...
    @Test
    public void testCreatePageUsingSourceEditor() {
        ...
        WebElement seleniumWebDriverLink = driver
        ...
        WebElement editorField = wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.id("wpTextbox1")));

        String pageText = "Selenium WebDriver is a browser automation tool that is widely used for web testing.";
        ...
        // Then the page is displayed with "Selenium WebDriver" as title and the
        ...
        assertTrue(pageBody.getText().contains(pageText));
